...
```javascript
iterRsqrt = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-rsqrt@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-rsqrt@v0.2.3-umd/browser.js"></script>
```
