...
```javascript
import iterRsqrt from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-rsqrt@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-rsqrt/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/math-iter-special-rsqrt/actions/workflows/test.yml?query=branch:v0.2.3
